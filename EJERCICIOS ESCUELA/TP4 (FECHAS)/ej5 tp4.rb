...
def calcular(fecha)
  ...
  conthora1=0 ; conthora2=0 ; igualdad=0
  ...
  if(igualdad==0)
    begin
      ...
      conthora1=conthora1+8
      conthora2=conthora2+2
    end until((aanow==aa) and (mmnow==mm) and (ddnow==dd))
    puts"Horas que has gastado en dormir hasta la fecha actual: #{conthora1} horas."
    puts"Horas que has gastado en comer hasta la fecha actual: #{conthora2} horas."
  else
